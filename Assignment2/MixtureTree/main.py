...
def save_results(loglikelihood, topology_array, theta_array, filename):
    ...
    likelihood_filename = outputfile + "_em_loglikelihood.npy"
    topology_array_filename = outputfile + "_em_topology.npy"
    theta_array_filename = outputfile + "_em_theta.npy"
...
def main():
    ...
    parser.add_argument('--sample_filename', type=str, default = '/Users/candacechou/homework/DD2434-Maching-Learning-Advanced-Course/Assignment2/AdvML19-master/2_5/data/q_2_5_tm_10node_20sample_4clusters_pkl_samples.txt',
                        help='Specify the name of the sample file (i.e data/example_samples.txt)')
    parser.add_argument('--output_filename', type=str, default = '/Users/candacechou/homework/DD2434-Maching-Learning-Advanced-Course/Assignment2/AdvML19-master/2_5/Result/q_2_5_tm_10node_20sample_4clusters_pkl_samples.txt',
